...
def plot_anomaly_detection(results, historical_csv, new_data_csv):
    ...
    os.makedirs('anomaly_detection_plots', exist_ok=True)
    ...
    plt.legend()
    plt.savefig('anomaly_detection_plots/anomaly_score_distribution.png')
    plt.close()
    ...
    plt.savefig('anomaly_detection_plots/pca_visualization.png')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('anomaly_detection_plots/feature_correlation.png')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('anomaly_detection_plots/parallel_coordinates.png')
    plt.close()
    ...
    plt.savefig('anomaly_detection_plots/metrics_comparison.png')
    plt.close()
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig('anomaly_detection_plots/time_series.png')
        plt.close()
            
    except Exception as e:
        print(f"Couldn't create time series plot: {e}")

    print("Anomaly detection plots saved to 'anomaly_detection_plots/' directory")
